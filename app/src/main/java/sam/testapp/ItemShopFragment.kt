...
class ItemShopFragment:Fragment(), ItemAdapter.onViewSelectedListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View = inflater.inflate(R.layout.fragment_item_shop,container,false)
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        recyclerView_shopItems.adapter = ItemAdapter(this, (activity as MainActivity).itemList.toMutableList())
    }
}
